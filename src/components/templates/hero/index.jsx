        ...
        <header className="bg-lightblue w-full h-screen max-h-[900px] grid items-center relative">
           <div className="container mx-auto h-full">
                <div 
                    ...
                    after:content-[''] after:absolute after:w-full after:h-full after:bg-ellipse after:bg-no-repeat after:bottom-0 after:object-contain after:bg-bottom xl:after:bg-right-bottom">
